...
brand = st.selectbox("Bilmärke", ["Ford", "Audi", "Volkswagen", "Honda", "Chevrolet", "BMW", "Hyundai", "Kia", "Toyota", "Mercedes"])
fuel_type = st.selectbox("Bränsletyp", ["Bensin", "Diesel", "El", "Hybrid"])
